...
public class Question {
	...
	public Question(Integer id, String question_title, String option1, String option2, String option3, String option4,
			String right_answer, String difficultyLevel, String category) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Question [id=" + id + ", question_title=" + question_title + ", option1=" + option1 + ", option2="
				...
				+ ", difficulty_level=" + difficultyLevel + ", category=" + category + "]";
	}
	public int getId() {
		return id;
	}
	...
	public void setDifficulty_level(String difficultyLevel) {
		this.difficultyLevel = difficultyLevel;
	}
